...
$b->setOptions(['use_referer' => true, 'default_target_path' => 'arii_Home_index', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path']);
