...
class Favorite extends \Arii\CoreBundle\Entity\Favorite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Favorite' . "\0" . 'id', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Favorite' . "\0" . 'user', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Favorite' . "\0" . 'bundle', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Favorite' . "\0" . 'level'];
        }
