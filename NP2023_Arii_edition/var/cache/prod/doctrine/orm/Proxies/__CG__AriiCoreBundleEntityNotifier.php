...
class Notifier extends \Arii\CoreBundle\Entity\Notifier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Notifier' . "\0" . 'id', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Notifier' . "\0" . 'title', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Notifier' . "\0" . 'description', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Notifier' . "\0" . 'notifications', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Notifier' . "\0" . 'connection'];
        }
