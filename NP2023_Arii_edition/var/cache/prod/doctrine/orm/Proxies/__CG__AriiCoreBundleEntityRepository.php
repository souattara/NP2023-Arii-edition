...
class Repository extends \Arii\CoreBundle\Entity\Repository implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'id', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'enterprise', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'db', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'name', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'description', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Repository' . "\0" . 'timezone'];
        }
